...
public class ExpandableVideoLoader extends BaseExpandableListAdapter {

    private Context context;
    private List<String> listDataHeader;
    private HashMap<String,List<DataLister>> listDataChild;

    public ExpandableVideoLoader(Context context, List<String> listDataHeader, HashMap<String, List<DataLister>> listDataChild) {
