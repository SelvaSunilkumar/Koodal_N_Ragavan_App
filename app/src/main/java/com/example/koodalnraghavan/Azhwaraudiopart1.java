...
public class Azhwaraudiopart1 extends AppCompatActivity {
    ...
    private Azhwarmusic1 azhwarmusic1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_azhwaraudiopart1);
        ...
        //getSupportActionBar().setTitle("AzhwargalManam Songs Part-1");

        database = FirebaseDatabase.getInstance();
        reference = database.getReference("part1");
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        try {
                            ...
                            mediaPlayer.prepare();
                            Toast.makeText(Azhwaraudiopart1.this, "Play", Toast.LENGTH_SHORT).show();
                            mediaPlayer.start();
                            pauseplaycounter = 0;
